    ...
    <div class="flex min-h-screen items-center justify-center p-4">
        <div class="relative w-full max-w-4xl rounded-lg bg-white shadow-xl transition-all">
            ...
            <div class="flex items-center justify-between rounded-t-lg bg-gradient-to-r from-blue-500 to-indigo-600 px-6 py-4">
                <h3 class="text-xl font-medium text-white">Edit Formation</h3>
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div class="space-y-4 md:col-span-2">
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex items-center">
                                    <div id="edit-image-preview" class="relative h-32 w-32 overflow-hidden rounded-md border-2 border-dashed border-gray-300 bg-gray-100">
                                        ...
                                        <img id="edit-preview-image" class="absolute inset-0 h-full w-full object-cover" alt="Preview">
                                    </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <label for="edit-trend" class="ml-2 block text-sm text-gray-700">Mark as trending</label>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4 rounded-lg bg-gray-50 p-4 md:col-span-2">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <div class="flex items-center">
                                    ...
                                    <label for="edit-lang-fr" class="ml-2 text-sm text-gray-700">French</label>
                                </div>
                                <div class="flex items-center">
                                    ...
                                    <label for="edit-lang-en" class="ml-2 text-sm text-gray-700">English</label>
                                </div>
                                <div class="flex items-center">
                                    ...
                                    <label for="edit-lang-ar" class="ml-2 text-sm text-gray-700">Arabic</label>
                                </div>
                                <div class="flex items-center">
                                    ...
                                    <label for="edit-lang-es" class="ml-2 text-sm text-gray-700">Spanish</label>
                                </div>
